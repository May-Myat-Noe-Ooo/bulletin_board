  ...
  <form class="form-horizontal" action="{{ route('postlist.update',$postlist->id) }}" method="POST">
      ...
      <div class="row mb-3">
          <div class="row d-flex justify-content-around align-item-center">
            ...
            <div class="col-sm-8"><input type="text" name="title" class="form-control" value="{{$title}}"></div>
          </div>
      </div>
      <div class="row mb-3">
        <div class="row d-flex justify-content-around align-item-center">
          <label for="" class="form-label col-sm-2 ">Description</label>`
          <div class="col-sm-8"><textarea class="form-control" name="description" id="textAreaExample1" rows="4">{{$des}}</textarea></div>
        </div>
      </div>
      <div class="row mb-3">
        <div class="row d-flex  justify-content-around align-item-center">
