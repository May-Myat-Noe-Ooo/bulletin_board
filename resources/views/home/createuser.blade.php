...
<div class="container-md col-sm-4 mt-5">
  ...
  <form class="form-horizontal" action="{{ route('registerconfirm') }}" method="POST">
        @csrf
      ...
      <div class="row mb-3">
        ...
        <label for="" class="form-label col-sm-2 ">Password Confirmation</label>
            <div class="col-sm-8"><input type="password" name="confirmpassword" class="form-control" value=""></div>
        </div>
      </div>
